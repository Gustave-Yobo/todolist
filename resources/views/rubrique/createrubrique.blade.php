        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Creation d'un status de la tâche</h5>
                                ...
                                <div class="w-full sm:max-w-lg mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
                                    ...
                                    <form method="POST" action="{{ route('rubrique.store') }}">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id=nom name="nom" :value="old('nom')" placeholder="Status de la tâche" required autofocus>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-sm-10">
