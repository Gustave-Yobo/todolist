    ...
    <div class="py-12">
        <div class="flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
            <div class="w-full sm:max-w-lg mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
                ...
                @endif
                <form action="{{ route('dashboard.update', $tache->id) }}" method="post">
                @csrf
                @method('put')

                <div class="mt-4">
                  <x-jet-label value="Titre" />
                  <x-jet-input class="block mt-1 w-full" type="text" id=titre name="titre" :value="old('titre', $tache->titre)" placeholder="Titre de la tâche" required autofocus />
                </div>
