                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="info-box card">
                                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sapiente, error? Sint quas nesciunt ex illo voluptate tempore sed quia blanditiis eum dignissimos, in reprehenderit odit veniam cum. Cupiditate, dolorum atque!</p>
                            </div>
                        </div>
                    </div>
                </div>
